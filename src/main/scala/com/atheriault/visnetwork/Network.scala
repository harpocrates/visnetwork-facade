...
class Network(container: raw.HTMLElement, data: Data, options: Network.Options) extends js.Object {
  ...
  def setSelection(selection: Network.Selection, options: SelectionOptions = ???): Unit = js.native
...
trait ClusterOptions extends js.Object {
  ...
  val processProperties
    : js.UndefOr[js.Function3[js.Any, js.Array[js.Any], js.Array[js.Any], js.Any]] = js.undefined
